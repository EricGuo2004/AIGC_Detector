...
| --- | --- | --- | --- |
| dataset | dataset root | PASS | PATH_TO_GenImage_data |
| dataset | ADM root | PASS | PATH_TO_GenImage_data\ADM |
...
| dataset | BigGAN root | PASS | PATH_TO_GenImage_data\BigGAN |
...
| dataset | VQDM root | PASS | PATH_TO_GenImage_data\VQDM |
...
| dataset | glide root | PASS | PATH_TO_GenImage_data\glide |
...
| report | report/main.tex | PASS | 42584 bytes |
| report | report/main.pdf | PASS | 5243244 bytes |
...
| report | report/figures/optimization_v2_macro_f1.png | PASS | 139239 bytes |
...
| notebook | valid JSON | PASS | 78 cells, 39 code cells |
...
| git | working tree status | WARN | M report/main.pdf
